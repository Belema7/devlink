  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      <Input
        ...
        className="h-12 rounded-full border-[#3a352f] bg-[#1f1d1a] pl-11 pr-24 text-zinc-100 placeholder:text-zinc-500 focus-visible:border-[#f5e27f]/60"
        value={searchValue}
      ...
      <div className="absolute inset-y-0 right-0 flex items-center gap-1 pr-2">
        ...
        {isPending ? <div className="mr-2 h-4 w-4 animate-spin rounded-full border-2 border-[#f5e27f] border-t-transparent" /> : null}
      </div>
    </div>
  );
}
