          ...
          <Card className="overflow-hidden border border-zinc-800 bg-zinc-950 text-zinc-100">
            <CardHeader className="space-y-5 border-b border-zinc-800 px-6 py-8 md:px-8">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge className="rounded-full border border-zinc-800 bg-zinc-950 px-3 py-1 text-xs text-zinc-200">
              ...
              <div className="space-y-3">
                ...
                <CardTitle className="max-w-4xl text-3xl leading-tight text-zinc-50 md:text-5xl">
                  {link.title}
                </CardTitle>
                <Link
                  href={link.url}
            ...
            <CardContent className="space-y-8 px-6 py-8 md:px-8">
              <div className="grid gap-4 sm:grid-cols-3">
                <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-4">
                  ...
                  <p className="mt-3 text-3xl font-semibold text-zinc-50">{link.voteCount}</p>
                ...
                <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-4">
                  ...
                  <p className="mt-3 text-3xl font-semibold text-zinc-50">Public</p>
                ...
                <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-4">
                  ...
                  <p className="mt-3 text-2xl font-semibold text-zinc-50">{publishedAt}</p>
                  ...
                  {link.tags.length > 0 ? (
                    link.tags.map((tag) => (
                      <Badge
                        key={tag.id}
                        variant="outline"
                        className="rounded-full border-zinc-800 bg-zinc-950 px-3 py-1 text-zinc-200"
                      >
                        {tag.name}
                      </Badge>
                    ))
              ...
              <div className="flex flex-wrap items-center gap-3 border-t border-zinc-800 pt-2">
                ...
                <Button asChild className="rounded-full border border-zinc-800 bg-zinc-100 text-zinc-950 hover:bg-zinc-200">
              ...
              <CardContent className="space-y-4">
                <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-4">
                  ...
                  <Link
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-2 block break-all text-sm font-medium text-zinc-100 transition-colors hover:text-zinc-300"
                  >
                    {link.url}
                  </Link>
                </div>
