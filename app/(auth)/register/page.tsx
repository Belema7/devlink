...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8">
        <p className="text-sm font-medium uppercase tracking-[0.28em] text-zinc-500">Get started</p>
        <h2 className="mt-4 text-3xl font-semibold tracking-tight text-zinc-100">Create account</h2>
